...
export default function Productos({
  ...
  const productos = allProductos.slice(0, 8); // Solo mostramos los primeros 8 en Home

  return (
    <section style={{ background: 'var(--acc-bg)', padding: '4.5rem 2rem' }}>
           ...
           <div style={{ textAlign: 'center', marginTop: '3rem' }}>
              <button
                 ...
                 style={{
                    ...
                    color: 'var(--acc-acento)',
                    border: '1px solid var(--acc-acento)',
                    borderRadius: '6px',
                    fontFamily: "'Jost',sans-serif",
                    fontSize: '.7rem',
                    fontWeight: 500,
